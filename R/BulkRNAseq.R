...
#' @slot misc A great place to store any other data associated with your bulk experiment that does not fit elsewhere in the object.  Components of the list can be of any type.  Left empty by default, and is not altered or used by any of the dittoSeq functions.
#' @seealso
#' \code{\link{importDESeq2}} for automated import of DESeq objects
#'
...
#' @return Outputs an RNAseq object with a new \code{@reductions$'name'} slot.
#' @seealso
...
#'
#' @param embeddings a numeric matrix containing the coordinated of all samples within the dimensionality reduction space.
#' @param object the \code{\linkS4class{RNAseq}} object. REQUIRED, unless \code{DEFAULT <- "object"} has been run.
#' @param name String name for the reduction slot. Example: "pca".
#' This will become the name of the slot, what should should be provided to the \code{reduction.use} input when making a \code{\link{dittoDimPlot}}.
#' @param key String, like "PC", which sets the default axes-label prefix when this reduction is used for making a \code{\link{dittoDimPlot}}.
